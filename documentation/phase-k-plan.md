...
**Status:** DONE (2026-05-15) — endings deferred to advance-time after iter 1 review caught a P0 bug (eager seq=4 INSERT bypassed intermediate template steps in post_advance); both surfaces now lazy + share `build_interjection_step` single source of truth
