...
- **Plan format conventions** mature: this doc mirrors [phase-e.md](phase-e.md) and [phase-f-toy-action-sprites.md](phase-f-toy-action-sprites.md) for `/build-phase` compatibility.
