...
- **Type:** operator
- **Issue:** #63 (CLOSED 2026-05-09)
- **Flags:** n/a (operator step; not invoked through `/build-step`)
- **Status:** DONE 2026-05-09 (commits `e983119` plan + `27efae6` scripts/runbook/templates; tag `pre-f5-cutover` at `e983119`; load smoke PASS via `scripts/f5_load_smoke.py`)
...
- **Type:** code
- **Issue:** #64 (CLOSED 2026-05-09)
- **Flags:** --reviewers code
- **Status:** DONE 2026-05-09 (commits `3c89487` + merge `7c3cf20`; real-GPU integration test PASSED end-to-end on RTX 4070 8 GB checkpoint mode: 128×128 RGBA, <5 s warm, <6 GB VRAM)
...
- **Status:** DONE 2026-05-09 (commits `25477fc` + `59eb1b5` + merge `9cba613`; 2 build-step iterations resolved 4-reviewer-gauntlet findings; 88 tests passing)
...
- **Type:** operator
- **Issue:** #66 (CLOSED 2026-05-09)
- **Flags:** n/a (operator step; manual art curation)
- **Status:** DONE 2026-05-09 (commit `27efae6`; 10 Pillow placeholder templates + manifest + CREDITS.md shipped under `data/sprites/templates/`; CC0 / operator-drawn; operator can replace any individual template later)
