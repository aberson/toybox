...
**Phase C step 15 + Phase D step 20 shipped 2026-05-03** (commits `20c9b97` + `87e692b`): activity-quality telemetry & eval scaffold (issue #23), and anti-signal feedback in the generator (issue #25). See `documentation/eval-fixtures.md` for the held-out fixture set.
