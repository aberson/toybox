<!-- BAD OUTPUT — DEFECT: boolean flag's include_router placed in the numeric/preset block, not the boolean cohort -->
<!-- Violates SKILL.md lines 190-194: "Add the include_router call inside the boolean-flag cohort ... a boolean flag does NOT go" in the numeric block -->
...
```python
    # Numeric/preset settings (non-alphabetical group).
