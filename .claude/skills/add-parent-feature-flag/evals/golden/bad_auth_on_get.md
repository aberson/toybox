<!-- BAD OUTPUT — DEFECT: parent-scope auth wrongly added to the GET endpoint -->
<!-- Violates SKILL.md line 92: "GET is unauthenticated (household read) ... do NOT add auth to GET" -->
