<!-- BAD OUTPUT — DEFECT: 422 detail is generic invalid_value instead of invalid_starfield_background_enabled -->
<!-- Violates SKILL.md line 162: "detail={\"error\": \"invalid_<FLAG_SNAKE>\"}" -->
