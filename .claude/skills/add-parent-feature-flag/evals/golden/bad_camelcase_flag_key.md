<!-- BAD OUTPUT — DEFECT: TS union/defaults/kiosk keys camelCased instead of snake_case -->
<!-- Violates SKILL.md lines 24,38: "TS union members + defaults keys + kiosk-path keys are snake_case ... do NOT camelCase those" -->
...
export const PHASE_K_FEATURE_FLAG_DEFAULTS: PhaseKFeatureFlags = {
  ...
  starfieldBackgroundEnabled: true,
};
```
...
> = {
  ...
  starfieldBackgroundEnabled: "/api/settings/starfield-background-enabled",
};
```
