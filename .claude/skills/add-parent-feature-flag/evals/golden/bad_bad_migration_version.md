<!-- BAD OUTPUT — DEFECT: migration reuses existing version 0021 instead of incrementing to 0022 -->
<!-- Violates SKILL.md line 210: "take MAX(version)+1, zero-pad to 4 digits" -->
...
## Step 4 — Migration seed (created `src/toybox/db/migrations/0021_starfield_background_enabled.sql`)

Verified highest existing version is `0021_drop_deprecated_play_flags.sql` → new file is `0021`.
