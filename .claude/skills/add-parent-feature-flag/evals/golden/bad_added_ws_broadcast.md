<!-- BAD OUTPUT — DEFECT: added a WebSocket broadcast on the settings PUT -->
<!-- Violates SKILL.md lines 95-96: "No WS broadcast on change ... Don't add one." -->
...
GET unauthenticated; PUT parent-scoped; no If-Match/409; 422 detail `invalid_starfield_background_enabled`; `check_same_thread=False` kept.
...
async def put_starfield_background_enabled_endpoint(
