<!-- BAD OUTPUT — DEFECT: kiosk path value single-quoted (lock-test regex silently drops it) -->
<!-- Violates SKILL.md line 260: "Double-quoted value (single quotes won't parse in the lock-test regex ...)" -->
