<!-- BAD OUTPUT — DEFECT: TS PHASE_K_FEATURE_FLAG_DEFAULTS value (false) drifts from backend default (True) -->
<!-- Violates SKILL.md line 250: "the lock test compares with `is` identity to the backend STARFIELD_BACKGROUND_ENABLED_DEFAULT" -->
...
export const PHASE_K_FEATURE_FLAG_DEFAULTS: PhaseKFeatureFlags = {
  ...
  starfield_background_enabled: false,
};
```
