<!-- BAD OUTPUT — DEFECT: migration seeds integer 1 instead of the string 'true' -->
<!-- Violates SKILL.md line 216: "Boolean value is the lowercase STRING 'true'/'false' (NOT 0/1 ...)" -->
...
INSERT OR IGNORE INTO settings (key, value) VALUES ('starfield_background_enabled', 1);
```
