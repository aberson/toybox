<!-- BAD OUTPUT — DEFECT: default constant abbreviated, breaks f"{key.upper()}_DEFAULT" -->
<!-- Violates SKILL.md line 37: "MUST be exactly `<FLAG_SNAKE>.upper() + \"_DEFAULT\"`" -->
...
__all__ = ["STARFIELD_BG_DEFAULT", "get", "set"]
```
...
-- STARFIELD_BG_DEFAULT in src/toybox/core/starfield_background_enabled.py.
--
...
```python
        "starfield_background_enabled": (starfield_background_enabled.STARFIELD_BG_DEFAULT),
```
