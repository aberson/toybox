<!-- BAD OUTPUT — DEFECT: migration adds its own BEGIN/COMMIT (runner already wraps the file) -->
<!-- Violates SKILL.md lines 213-217: "NO BEGIN/COMMIT/ROLLBACK of your own" -->
