<!-- BAD OUTPUT — DEFECT: dropped the load-bearing `# noqa: A001` on set() -->
<!-- Violates SKILL.md lines 46,76: "The `# noqa: A001` on `set` is load-bearing ... keep it exactly" -->
...
def set(conn: sqlite3.Connection, value: bool) -> bool:
