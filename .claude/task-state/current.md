...
- Step Z6 (#8) PASS iter 1/3: neural_voice_enabled flag end-to-end via recipe; migration 0031; OFF-override integration test. pytest +7, vitest 897 (+2). Checkpoint pending; #8 closing.

## WIP
**Current:** Step Z7-prep (#9): audition batch script — final code step of the goal span; STOP after this (Z7/Z8/Z9 are operator handoff #10-#12)
