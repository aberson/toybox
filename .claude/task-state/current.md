...
## WIP
**Current:** Step Z5 (#7): kiosk clip playback with fallback — heading to ITERATION 2 (3 reviewers in: bugs 3 MED [post-settle focus theft in JokeStep reveal-gap replay; no settle-timeout watchdog vs #207 silent-drop → punchline audio dead; prime WAV has 0 samples — iOS unlock risk], test-quality 3 MED [trim; previewStep≠currentStep split untested; stopClip doc over-promise], style 3 LOW; correctness pending)
